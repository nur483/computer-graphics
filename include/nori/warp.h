...
public:
    ...
    /// Warp a uniformly distributed square sample to a GTR1 distribution for the given 'alpha' parameter
    ...
    /// Warp a uniformly distributed square sample to a GTR2 distribution for the given 'alpha' parameter
